package com.therapyconnect.platform.progressandtracking.interfaces.rest;
...
import com.therapyconnect.platform.progressandtracking.interfaces.rest.resources.CreateTeacherNoteResource;
import com.therapyconnect.platform.progressandtracking.interfaces.rest.resources.TeacherNoteResource;
import com.therapyconnect.platform.progressandtracking.interfaces.rest.resources.UpdateTeacherNoteResource;
import com.therapyconnect.platform.progressandtracking.interfaces.rest.transform.CreateTeacherNoteCommandFromResourceAssembler;
import com.therapyconnect.platform.progressandtracking.interfaces.rest.transform.TeacherNoteResourceFromEntityAssembler;
import com.therapyconnect.platform.progressandtracking.interfaces.rest.transform.UpdateTeacherNoteCommandFromResourceAssembler;
...
import com.therapyconnect.platform.shared.interfaces.rest.resources.MessageResource;
import com.therapyconnect.platform.shared.interfaces.rest.transform.ResponseEntityAssembler;
    ...
    public ResponseEntity<?> createTeacherNote(@RequestBody CreateTeacherNoteResource resource) {
        ...
        var result = teacherNoteCommandService.handle(createTeacherNoteCommand)
                .flatMap(noteId -> teacherNoteQueryService.handle(new GetTeacherNoteByIdQuery(noteId))
                        .<Result<com.therapyconnect.platform.progressandtracking.domain.model.aggregates.TeacherNote, ApplicationError>>
                                map(Result::success)
