package com.open.therapyconnect.platform.iam.interfaces.acl;

import com.open.therapyconnect.platform.iam.application.commandservices.UserCommandService;
import com.open.therapyconnect.platform.iam.application.queryservices.UserQueryService;
...
import com.open.therapyconnect.platform.iam.domain.model.queries.GetUserByIdQuery;
import com.open.therapyconnect.platform.iam.domain.model.queries.GetUserByUsernameQuery;
...
public class IamContextFacade {
    ...
    public Long createUser(String username, String password) {
        ...
        if (result instanceof com.open.therapyconnect.platform.shared.application.result.Result.Success
                (var user)) {
            return user.getId();
        }
        return 0L;
